...
const outputs = [
  ['master-items.json', {
    ...
    totalMaterials: allMaterials.length, totalArtifacts: allArtifacts.length,
    items: [...allItems, ...allArmor, ...allConsumables],
  }],
  ['master-weapons.json', {
    version: '3.0.0', generated: now,
    total: allItems.length, totalWeapons: allItems.length,
    items: allItems,
  }],
  ['master-armor.json', {
    version: '3.0.0', generated: now,
    total: allArmor.length, totalArmor: allArmor.length,
    items: allArmor,
  }],
  ['master-consumables.json', {
    version: '3.0.0', generated: now,
    total: allConsumables.length, totalConsumables: allConsumables.length,
    items: allConsumables,
  }],
  ['master-materials.json', {
    version: '3.0.0', generated: now,
    total: allMaterials.length, totalMaterials: allMaterials.length,
    materials: allMaterials,
  }],
  ['master-recipes.json', {
    version: '3.0.0', generated: now,
    total: allRecipes.length, totalRecipes: allRecipes.length,
    recipes: allRecipes,
  }],
  ['master-artifacts.json', {
    version: '3.0.0', generated: now,
    total: allArtifacts.length, totalArtifacts: allArtifacts.length,
