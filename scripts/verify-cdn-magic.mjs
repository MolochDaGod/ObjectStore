...
const CHECKS = [
  ...
  { path: 'js/grudge-id-client.js', expect: 'js' },
  { path: 'js/grudge6-kit.js', expect: 'js' },
  { path: 'js/grudge-game-bootstrap.js', expect: 'js-or-404' },
  { path: 'grudge-fleet.js', expect: 'js-or-404' },
  { path: 'grudge-game-bootstrap.js', expect: 'js-or-404' },
  { path: 'models/grudge6/races/WK_Characters.glb', expect: 'glb' },
  { path: 'models/grudge6/races/WK_Characters.fbx', expect: 'fbx' },
  { path: 'models/_optimized/buildings/cantina.glb', expect: 'glb-or-404' },
  { path: 'models/_optimized/buildings/tavern.glb', expect: 'glb-or-404' },
