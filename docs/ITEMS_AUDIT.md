...
- base names: Emberwrath Staff, Inferno Spire, Phoenix Staff, Sunfire Staff

### food-blue
- base items: **2**  tier rows: 2  unique icons: 1
- icon collisions: **1**
    - `https://molochdagod.github.io/ObjectStore/icons/consumables/food_fish_red.png` shared by: Fish Stew, Nectar of Gods
- base names: Fish Stew, Nectar of Gods

### food-green
- base items: **2**  tier rows: 2  unique icons: 1
- icon collisions: **1**
    - `https://molochdagod.github.io/ObjectStore/icons/consumables/food_grapes.png` shared by: Simple Salad, World Tree Nectar
- base names: Simple Salad, World Tree Nectar

### food-red
- base items: **2**  tier rows: 2  unique icons: 1
- icon collisions: **1**
    - `https://molochdagod.github.io/ObjectStore/icons/consumables/food_steak_cooked.png` shared by: Grilled Steak, Dragon Steak
- base names: Dragon Steak, Grilled Steak
...
### holyStaves
- base items: **4**  tier rows: 32  unique icons: 4
- base names: Dawnspire, Divine Judgment Staff, Redemption Staff, Sacred Light
...
- icon collisions: **3**
    - `https://molochdagod.github.io/ObjectStore/icons/consumables/health_potion.png` shared by: Minor Health Potion, Health Potion, Greater Health Potion
    - `https://molochdagod.github.io/ObjectStore/icons/consumables/mana_potion.png` shared by: Minor Mana Potion, Mana Potion, Greater Mana Potion
    - `https://molochdagod.github.io/ObjectStore/icons/consumables/potion_42.png` shared by: Divine Health, Elixir of Immortality
...
### offhand (165 not-in-master)
- shield: 76
- tome: 72
- spear: 9
- staff: 8

### relic (266 not-in-master)
- material-ore: 217
- shield: 9
- armor-back: 8
- potion: 8
- tome: 8
- spear: 8
- accessory-necklace: 8

### ring (55 not-in-master)
- accessory-ring: 55

### skill (130 not-in-master)
- material-ore: 104
- sword: 8
- shield: 4
- armor-helm: 3
