/**
 * grudge6 weapon hold pose SSOT — post-mixer residual on hand sockets.
 *
 * Stack (do not fork):
 *   1. Attach weapon to R/L_hand_container (kit or lab)
 *   2. Static gripOffset / gripEuler (grudge6-lab-weapons applyGripTransform)
 *   3. **This file** — after AnimationMixer.update, gait residual on hands
...
/**
 * Per-kind · per-gait residual (radians / metres) applied AFTER mixer.
 * Positive euler.x ≈ tip forward/down; euler.z ≈ roll in palm.
...
/**
 * Map kit equip slot / catalog kind → hold table key.
...
/**
 * Mirror main pose → off when off table missing (1H dual).
 ...
 * @param {string} kind weapon kind / kit slot (sword, dagger, staff, …)
 * @param {{
 *   THREE?: any,
 *   hand?: 'main'|'off'|'both',
 *   offKind?: string|null,
